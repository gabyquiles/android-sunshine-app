 ...
 */
package com.gabyquiles.sunshine.data;
    ...
    */
    public void testLocationTable() {
        ...
        Cursor cursor = db.query(WeatherContract.LocationEntry.TABLE_NAME, null,
                ...
                new String[] {locationRowId.toString()}, null, null, null);
        ...
        TestUtilities.validateCurrentRecord("ERROR: Row not as expected", cursor, northPoleLocation);
    ...
    public void testWeatherTable() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("ERROR: Row not as expected", cursor, weather);
    ...
    public long insertLocation(SQLiteDatabase db) {
        ...
        assertFalse("Error: Record not inserted", locationRowId == -1);
