...
public class Utility {
    ...
    public static String getFormattedMonthDay(Context context, long dateInMillis ) {
        Time time = new Time();
        time.setToNow();
        SimpleDateFormat monthDayFormat = new SimpleDateFormat(Utility.DATE_FORMAT);
        String monthDayString =  getDayName(context, dateInMillis) + ", " + monthDayFormat.format(dateInMillis);
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        String url = prefs.getString(context.getString(R.string.pref_iconset_key), null);
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
            return context.getString(R.string.format_art_url, url, "storm");
        } else if (weatherId >= 300 && weatherId <= 321) {
            return context.getString(R.string.format_art_url, url, "light_rain");
        } else if (weatherId >= 500 && weatherId <= 504) {
            return context.getString(R.string.format_art_url, url, "rain");
        } else if (weatherId == 511) {
            return context.getString(R.string.format_art_url, url, "snow");
        } else if (weatherId >= 520 && weatherId <= 531) {
            return context.getString(R.string.format_art_url, url, "rain");
        } else if (weatherId >= 600 && weatherId <= 622) {
            return context.getString(R.string.format_art_url, url, "snow");
        } else if (weatherId >= 701 && weatherId <= 761) {
            return context.getString(R.string.format_art_url, url, "fog");
        } else if (weatherId == 761 || weatherId == 781) {
            return context.getString(R.string.format_art_url, url, "storm");
        } else if (weatherId == 800) {
            return context.getString(R.string.format_art_url, url, "clear");
        } else if (weatherId == 801) {
            return context.getString(R.string.format_art_url, url, "light_clouds");
        } else if (weatherId >= 802 && weatherId <= 804) {
            return context.getString(R.string.format_art_url, url, "clouds");
        }
        return null;
    }
